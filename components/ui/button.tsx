...
const BlueButton = (props: CustomButtonProps) => {
  return (
    <Button
...
const GrayButton = (props: CustomButtonProps) => {
  return (
    <Button
      {...props}
      className="w-full font-geist tracking-tighter text-center rounded-md bg-gradient-to-br from-gray-400 to-gray-700 px-4 py-2 text-lg text-zinc-50 ring-2 ring-gray-500/50 ring-offset-2 ring-offset-zinc-950 transition-all hover:scale-[1.02] hover:ring-transparent active:scale-[0.98] active:ring-gray-500/70 flex items-center justify-center gap-2">
      {props.children}
    </Button>
  );
};

const GlassButton = (props: CustomButtonProps) => {
  return (
    <Button
      disabled={props.disabled}
      onClick={props.onClick}
      className={`text-white rounded-xl inline-flex text-center group items-center w-full justify-center bg-gradient-to-tr from-zinc-300/5 via-gray-400/5 to-transparent bg-transparent  border-input border-[1px] hover:bg-transparent/10 transition-colors sm:w-auto py-2 px-4 text-sm ${props.className}`}
    >
      {props.children}
    </Button>
  );
...
export { Button, buttonVariants, BlueButton, GrayButton, GlassButton};
